...
"""Verify that starting lksd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start lksd with -h for help text")
        ...
        self.log.info("Start lksd with -version for version information")
