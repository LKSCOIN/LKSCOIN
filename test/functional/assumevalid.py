...
class AssumeValidTest(BitcoinTestFramework):
    ...
    def send_blocks_until_disconnected(self, p2p_conn):
        ...
        for i in range(len(self.blocks)):
            ...
            # We can reenable the correct exception handling and the assert when Bitcoin 3.3 mininode.py changes have been
            # backported
            #except IOError as e:
            except:
    ...
    def run_test(self):
        ...
        # Bury the assumed valid block 8400 deep (Lks needs 4x as much blocks to allow -assumevalid to work)
        for i in range(8400):
            block = create_block(self.tip, create_coinbase(height), self.block_time)
            block.nVersion = 4
            block.solve()
