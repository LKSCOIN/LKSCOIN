...
class LLMQCoinbaseCommitmentsTest(LksTestFramework):
    def set_test_params(self):
        self.set_lks_test_params(4, 3, fast_dip3_enforcement=True)
        self.set_lks_dip8_activation(200)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as LksTestFramework doesn't support this atm)
