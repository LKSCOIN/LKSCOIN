Contributing to Lksc Core
============================

The Lksc Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/LKSCOIN/LKSCOIN/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Lksc Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Lks
Network Protocol consensus changes.

Whether a pull request is merged into Lksc Core rests with the project merge
...
Patches that change Lks consensus rules are considerably more involved than
...
Where a patch set proposes to change the Lks consensus, it must have been
...
The review process is normally fairly responsive on the Lksc Core repository, however
...
The project leader is the release manager for each Lksc Core release.
