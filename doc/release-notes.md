...
Read more about ChainLocks: https://github.com/lkspay/dips/blob/master/dip-0008.md
Read more about LLMQ-based InstantSend: https://github.com/lkspay/dips/blob/master/dip-0010.md
...
-------------------------
Nodes joining the network will now try to sync their mempool from other v3.2+ peers via the `mempool` p2p message.
...
- individual Lksc-specific fields which were used to display soft-fork progress in `getblockchaininfo` are replaced
...
There are also new RPC commands backported from Bitcoin Core 3.2:
- `abortrescan`
...
Make sure to check Bitcoin Core 3.2 release notes in a [section](#backports-from-bitcoin-core-015) below
...
Backports from Bitcoin Core 3.2
--------------------------------

Most of the changes between Bitcoin Core 0.14 and Bitcoin Core 3.2 have been backported into Lksc Core 3.2.
We only excluded backports which do not align with Lksc, like SegWit or RBF related changes.

You can read about changes brought by backporting from Bitcoin Core 3.2 in following docs:
- https://github.com/bitcoin/bitcoin/blob/master/doc/release-notes/release-notes-3.2.0.md
- https://github.com/bitcoin/bitcoin/blob/master/doc/release-notes/release-notes-3.2.1.md

Some other individual PRs were backported from versions 0.16+, you can find the full list of backported PRs
and additional fixes in https://github.com/LKSCOIN/LKSCOIN/blob/master/doc/release-notes/lks/release-notes-3.2-backports.md

Miscellaneous
-------------
A lot of refactoring, backports, code cleanups and other small fixes were done in this release. Lksc-specific
modules were reorganized in separate folders to make navigation through code a bit easier.

3.2 Change log
===============

See detailed [set of changes](https://github.com/LKSCOIN/LKSCOIN/compare/v0.14.0.5...lkspay:v3.2.0.0).
...
- [`f23e722da`](https://github.com/LKSCOIN/LKSCOIN/commit/f23e722da) Switch CLIENT_VERSION_IS_RELEASE to `true` for v3.2 (#3306)
...
- [`672e18e48`](https://github.com/LKSCOIN/LKSCOIN/commit/672e18e48) Only sync mempool from v3.2+ (proto 70216+) nodes (#3321)
...
- [`ce924278d`](https://github.com/LKSCOIN/LKSCOIN/commit/ce924278d) Don't load caches when blocks/chainstate was deleted and also delete old caches (#3280)
...
- [`37f96f5a3`](https://github.com/LKSCOIN/LKSCOIN/commit/37f96f5a3) Bump version to 3.2 and update few const-s/chainparams (#3204)
...
- [`df3dbe85b`](https://github.com/LKSCOIN/LKSCOIN/commit/df3dbe85b) Wait for sporks to propagate in llmq-chainlocks.py before mining new blocks (#3168)
...
- [`737ac967f`](https://github.com/LKSCOIN/LKSCOIN/commit/737ac967f) Refactor some Lksc-specific `wait_for*` functions in tests (#3122)
...
- [`3ac583cce`](https://github.com/LKSCOIN/LKSCOIN/commit/3ac583cce) docs: Add packages for building in Alpine Linux (#3115)
...
- [`cbbeec689`](https://github.com/LKSCOIN/LKSCOIN/commit/cbbeec689) RPC Getrawtransaction fix (#3065)
...
- [`1f6e0435b`](https://github.com/LKSCOIN/LKSCOIN/commit/1f6e0435b) [Trivial] Fix a typo in a comment in mnauth.h (#2988)
...
- [`a3f030609`](https://github.com/LKSCOIN/LKSCOIN/commit/a3f030609) Implement getmerkleblocks rpc (#2894)
- [`32aa229c7`](https://github.com/LKSCOIN/LKSCOIN/commit/32aa229c7) Reorganize Lksc Specific code into folders (#2753)
