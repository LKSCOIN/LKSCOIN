...
This document provides guidelines for internationalization of the Lksc Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `lks_en.ts` remains unchanged.
