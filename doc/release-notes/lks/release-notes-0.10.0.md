...
0.10.2.27 Release notes
------------------------

- removed inputs < 1 COIN from DS


0.10.2.26 Release notes
------------------------

- minor bugfix


0.10.2.25 Release notes
------------------------

RC4 released!


0.10.2.24 Release notes
------------------------
...
0.10.2.16 Release notes
------------------------

- bugfixes


0.10.2.15 Release notes
------------------------
...
/darkcoin-qt -datadir=/home/user/.darkcoin -listen=0 -darksendrounds=8 -usemasternode="192.168.56.102:19400"
/darkcoin-qt -datadir=/home/user/.darkcoin2 -listen=0 -darksendrounds=8 -usemasternode="192.168.56.102:19400"

and even disable darksend auto-denom if wanted:
/darkcoin-qt -datadir=/home/user/.darkcoin -listen=0 -darksendrounds=8 -usemasternode="192.168.56.102:19400" -disabledarksend=1


0.10.2.7 Release notes
-----------------------
...
0.10.2.3 Release notes
-----------------------

- min merged transactions

0.10.2.2 Release notes
-----------------------
