...
and outputs, they are most useful for financial transactions (i.e. transfers of quantities of Lksc
...
The introduction of special transactions will require the whole Lksc ecosystem to perform a one-time
...
Read more: https://github.com/lkspay/dips/blob/master/dip-0002.md
...
entry to that masternode list after the owner created a 1000 Lksc UTXO and the masternode broadcast
...
transaction which includes either a 1000-Lksc collateral payment or a reference to it, along with
other payload information (DIP0002).

The new system is going to be activated via combination of a BIP9-like deployment (bit 3) and new spork
(`SPORK_15_DETERMINISTIC_MNS_ENABLED`).

Read more: https://github.com/lkspay/dips/blob/master/dip-0003.md
Upgrade instructions: https://docs.lks.org/DIP3-masternode-upgrade

DIP0004 - Simplified Verification of Deterministic Masternode Lists
-------------------------------------------------------------------
A verifiable and correct masternode list is foundational to many Lksc features, including verification
...
Read more: https://github.com/lkspay/dips/blob/master/dip-0004.md
...
Transaction https://github.com/lkspay/dips/blob/master/dip-0004.md#coinbase-special-transaction.
...
Some other (mostly minor) issues were also fixed, see `GUI` part of `3.1.0.0 Change log` section below for
...
See detailed [set of changes](https://github.com/LKSCOIN/LKSCOIN/compare/v0.12.3.4...lkspay:v3.1.0.0).
...
- [`18e1edabf`](https://github.com/LKSCOIN/LKSCOIN/commit/18e1edabf) Backport 2618 to v3.1.0.x (#2619)
...
- [`579c83e88`](https://github.com/LKSCOIN/LKSCOIN/commit/579c83e88) Add coinbase_payload to getblocktemplate help (#2437)
...
- [`225c2135e`](https://github.com/LKSCOIN/LKSCOIN/commit/225c2135e) Allow skipping of MN payments with zero duffs (#2534)
...
- [`927e8bd79`](https://github.com/LKSCOIN/LKSCOIN/commit/927e8bd79) Also forbid reusing collateral key for owner/voting keys
...
- [`cc73422f8`](https://github.com/LKSCOIN/LKSCOIN/commit/cc73422f8) Add methods to add/remove (non-)deterministic MNs
...
- [`a5643f899`](https://github.com/LKSCOIN/LKSCOIN/commit/a5643f899) Switch RequestGovernanceObjectVotes from pointers to hashes (#2189)
...
- [`10b3736bd`](https://github.com/LKSCOIN/LKSCOIN/commit/10b3736bd) [3.1.0.x] Translations201901 (#2592)
- [`34d2a6038`](https://github.com/LKSCOIN/LKSCOIN/commit/34d2a6038) Release notes 3.1.0.0 draft (#2583)
...
- [`cbd030352`](https://github.com/LKSCOIN/LKSCOIN/commit/cbd030352) Serialize the block header in CBlockHeader::GetHash() (#2531)
...
- [`6560ac64b`](https://github.com/LKSCOIN/LKSCOIN/commit/6560ac64b) Properly escape $ in Jenkinsfile.gitian (#2404)
...
- [`9eb9c99d5`](https://github.com/LKSCOIN/LKSCOIN/commit/9eb9c99d5) Bump version to 3.1.0 (#2386)
...
- [`b3fc236af`](https://github.com/LKSCOIN/LKSCOIN/commit/b3fc236af) Fix mnodeman.cs vs cs_vPendingMasternodes vs cs_main deadlock (#2200)
...
- [`e002c50b0`](https://github.com/LKSCOIN/LKSCOIN/commit/e002c50b0) Add "immer" functional/immutable containers library (#2244)
...
- [`1681d6366`](https://github.com/LKSCOIN/LKSCOIN/commit/1681d6366) Replace Lksc-specific threads with Lksc-specific scheduled tasks (#2043)
- [`dac090964`](https://github.com/LKSCOIN/LKSCOIN/commit/dac090964) remove lkspay.io dns seed entry (#2181)
...
- [`e23339d6f`](https://github.com/LKSCOIN/LKSCOIN/commit/e23339d6f) use nullptr in Lksc-specific code (#2166)
...
- [`8ee9333bc`](https://github.com/LKSCOIN/LKSCOIN/commit/8ee9333bc) remove boost dependency from Lksc-specific code (#2072)
