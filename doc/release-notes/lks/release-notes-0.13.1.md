...
See detailed [set of changes](https://github.com/LKSCOIN/LKSCOIN/compare/v0.13.0.0...lkspay:v0.13.1.0).
...
- [`070ad103f`](https://github.com/LKSCOIN/LKSCOIN/commit/070ad103f) Wait for script checks to finish before messing with txes in Lks-specific way (#2652)
