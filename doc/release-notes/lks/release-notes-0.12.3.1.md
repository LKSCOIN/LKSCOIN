...
We introduced a new signature format for Lks-specific network messages,
...
However this option is only available in so called Lite Mode. In this mode, Lks specific features are disabled, meaning
...
mnprivkey during MN setup and NOT the one that controls the 1000 LKSC collateral) which should make the process of pairing with
...
The alert system was also kept in place for now. We are going to continue backporting the most notable fixes and improvements from Bitcoin Core versions 0.15 and 3.3 in future releases.
...
- [`8a387ee09`](https://github.com/LKSCOIN/LKSCOIN/commit/8a387ee09) Drop SPORK_13_OLD_SUPERBLOCK_FLAG and check superblock start hash (#1872)
...
- [`08033ffe4`](https://github.com/LKSCOIN/LKSCOIN/commit/08033ffe4) Reject Lks-specific messages from obsolete peers (#1983)
...
- [`532b9fa3d`](https://github.com/LKSCOIN/LKSCOIN/commit/532b9fa3d) Use OpenNetworkConnection instead of calling ConnectNode directly in Lks code (#1857)
...
- [`7b43720f0`](https://github.com/LKSCOIN/LKSCOIN/commit/7b43720f0) Fix copying of final binaries into lkscore-binaries (#2090)
...
- [`611879aa6`](https://github.com/LKSCOIN/LKSCOIN/commit/611879aa6) Use spork addresses instead of raw keys and allow changing them on startup (#1969)
...
- [`c65613350`](https://github.com/LKSCOIN/LKSCOIN/commit/c65613350) Switch masternode id in Lks data structures from CTxIn to COutPoint (#1933)
...
- [`a7fa07a30`](https://github.com/LKSCOIN/LKSCOIN/commit/a7fa07a30) Drop BOOST_FOREACH and use references in loops (const ref where applicable, Lks code only) (#1899)
...
- [`ebbd26a05`](https://github.com/LKSCOIN/LKSCOIN/commit/ebbd26a05) Drop IsInputAssociatedWithPubkey and optimize CheckOutpoint (#1783)
