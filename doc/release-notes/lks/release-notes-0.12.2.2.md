...
Keeping a wallet with 1000 LKSC unlocked for 24/7 is definitely not a good idea
...
- [`753cb1563`](https://github.com/LKSCOIN/LKSCOIN/commit/753cb1563) Backport #7874: Improve AlreadyHave
...
- [`249db2776`](https://github.com/LKSCOIN/LKSCOIN/commit/249db2776) Backport #9999: [LevelDB] Plug leveldb logs to bitcoin logs
...
- [`9ad56fe18`](https://github.com/LKSCOIN/LKSCOIN/commit/9ad56fe18) Lks related fixes for per-utxo DB
...
- [`4102211a3`](https://github.com/LKSCOIN/LKSCOIN/commit/4102211a3) Backport #10526: Force on-the-fly compaction during pertxout upgrade
...
### Network/Sync:
- [`5d58dd90c`](https://github.com/LKSCOIN/LKSCOIN/commit/5d58dd90c) Make sure to clear setAskFor in Lks submodules (#1730)
