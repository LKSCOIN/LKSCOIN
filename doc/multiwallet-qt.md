...
Only requiring some minor changes is lks.cpp.
...
Changes to lks.cpp
----------------------
lks.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
