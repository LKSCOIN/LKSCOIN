...
* Update hardcoded [seeds](/contrib/seeds/README.md). TODO: Give example PR for Lksc
...
### Lksc Core maintainers/release engineers, update (commit) version in sources
...
### Build and sign Lksc Core for Linux, Windows, and OS X:
    ...
    pushd ./gitian-builder
    ./bin/gbuild --memory 3000 --commit lks=v${VERSION} ../lks/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --memory 3000 --commit lks=v${VERSION} ../lks/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --memory 3000 --commit lks=v${VERSION} ../lks/contrib/gitian-descriptors/gitian-osx.yml
...
- Announce the release:
  ...
  - Release on Lksc forum: https://www.lksfoundation.org/topic/official-announcements.54/
