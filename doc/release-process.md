...
* Update translations, see [translation_process.md](https://github.com/lkspay/lks/blob/master/doc/translation_process.md#syncing-with-transifex)
...
### LksCoin Core maintainers/release engineers, update (commit) version in sources
...
### Build and sign LksCoin Core for Linux, Windows, and OS X:

	./bin/gbuild --commit lks=v${VERSION} ../lks/contrib/gitian-descriptors/gitian-linux.yml
	...
	./bin/gbuild --commit lks=v${VERSION} ../lks/contrib/gitian-descriptors/gitian-win.yml
	...
	./bin/gbuild --commit lks=v${VERSION} ../lks/contrib/gitian-descriptors/gitian-osx.yml
...
### Verify other gitian builders signatures to your own. (Optional)
  ...
  Add other gitian builders keys to your gpg keyring
	...
	gpg --import ../lks/contrib/gitian-downloader/*.pgp
...
Commit your signature to gitian.sigs:
  ...
  Wait for Windows/OS X detached signatures:
	...
	Detached signatures will then be committed to the [lks-detached-sigs](https://github.com/lkspay/lks-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the lks.org server
...
- Announce the release:
  ...
  - Lks-development mailing list

  - Update title of #lkspay on Freenode IRC

  - Optionally reddit /r/Lkspay, ... but this will usually sort out itself
