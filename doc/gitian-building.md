...
*Setup instructions for a Gitian build of LksCoin Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Lks
...
- [Building LksCoin Core](#building-lks-core)
...
```bash
wget http://archive.ubuntu.com/ubuntu/pool/universe/v/vm-builder/vm-builder_0.2.4+bzr494.orig.tar.gz
echo "76cbf8c52c391160b2641e7120dbade5afded713afaa6032f733a261f13e6a8e  vm-builder_0.2.4+bzr494.orig.tar.gz" | sha256sum -c
# (verification -- must return OK)
tar -zxvf vm-builder_0.2.4+bzr494.orig.tar.gz
cd vm-builder-0.2.4+bzr494
...
Clone the git repositories for LksCoin Core and Gitian.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/lkspay/lks
```
...
in the LksCoin Core repository under 'Fetch and build inputs' to install sources which require
...
To build LksCoin Core (for Linux, OS X and Windows) just follow the steps under 'perform
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the LksCoin Core repository.
...
```bash
    ...
    From https://github.com/lkspay/lks
...
cd /some/root/path/
git clone https://github.com/lkspay/lks-detached-sigs.git

BTCPATH=/some/root/path/lks.git
SIGPATH=/some/root/path/lks-detached-sigs.git
