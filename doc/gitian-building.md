...
Gitian builds' in [doc/release-process.md](release-process.md#setup-and-perform-gitian-builds) in the Lksc Core repository.
...
[lks/gitian.sigs](https://github.com/LKSCOIN/LKSCOIN/gitian.sigs/) repository, or if that's not possible to create a pull
request.
