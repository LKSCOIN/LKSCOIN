...
LksCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as LksCoin Core, where everyone uses
...
pay attention to for reviewers of LksCoin Core code.

General LksCoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: LksCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
