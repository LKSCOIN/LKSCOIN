# Linearize
Construct a linear, no-fork, best version of the Lksc blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install lks_hash

https://github.com/LKSCOIN/LKSCOIN_hash
...
JSON-RPC server. Running `lksd` or `lks-qt -server` will be sufficient.
...
* `input`: lksd blocks/ directory containing blkNNNNN.dat
