...
enum ServiceFlags : uint64_t {
    ...
    // set by all Lksc Core nodes, and is unset by SPV clients or other peers that just want
...
enum GetDataMsg {
    ...
    MSG_SPORK = 6,
    /* 7 - 15 were used in old Lksc versions and were mainly budget and MN broadcast/ping related*/
    MSG_DSTX = 16,
