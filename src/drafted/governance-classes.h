 ...
 *
 *   // network
 *   CLksNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.lks.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CLksNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: LksNetwork
// //   -- signature requirements : Key1(User)
// class CLksNetworkVariable : public CGovernanceObject
// {
// private:
