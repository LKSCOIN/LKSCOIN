    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("LKSC-light"), QVariant("light"));
    ui->theme->addItem(QString("LKSC-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("LKSC-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("LKSC-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("LKSC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("LKSC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("LKSC-traditional"), QVariant("trad"));
