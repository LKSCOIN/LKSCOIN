...
/** Utility functions used by the Lks Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "lks:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load lks specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a lks specific theme is activated (light/dark).*/
    bool lksThemeActive();
