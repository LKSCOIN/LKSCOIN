...
void BitcoinGUI::createActions()
{
    ...
    // privateSendCoinsAction->setStatusTip(tr("PrivateSend coins to a Lks address"));
    ...
    aboutAction->setStatusTip(tr("Show information about Lksc Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Lks command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateWidth()
{
    ...
    // Use nButtonsVisible + 1 <- for the lks logo
...
{
    QString strTitle = tr("Lksc Core"); // default title
