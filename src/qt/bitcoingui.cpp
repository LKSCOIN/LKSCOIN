    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("LksCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Lks address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lks: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About LksCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about LksCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LksCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Lks addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Lks addresses"));
    ...
    openAction->setStatusTip(tr("Open a lks: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the LksCoin Core help message to get a list with possible LksCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("LksCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Lks network", "", count));
    } else {
...
{
    QString strTitle = tr("LksCoin Core"); // default title
