...
//
//     src/qt/test/test_lks-qt -platform xcb      # Linux
//     src/qt/test/test_lks-qt -platform windows  # Windows
//     src/qt/test/test_lks-qt -platform cocoa    # macOS
void TestGUI()
{
    GUIUtil::loadFonts();
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(2).indexOf(QString("URI: lks:")) != -1);
