    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("LksCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About LksCoin Core"));
...
These denominations are 0.01 LKS, 0.1 LKS, 1 LKS and 10 LKS -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://lkspay.atlassian.net/wiki/display/DOC/PrivateSend\">https://lkspay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("LksCoin Core is shutting down...") + "<br /><br />" +
