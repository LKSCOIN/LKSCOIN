...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nThreshold = 640; // 80% of 800
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nThreshold = 640; // 80% of 800
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nThreshold = 640; // 80% of 800
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nThreshold = 80; // 80% of 800
        ...
        chainTxData = ChainTxData{
            1587739673 // * UNIX timestamp of last known number of transactions (Block 1173619)
...
public:
    CTestNetParams() {
        ...
        consensus.nSuperblockStartHash = uint256S("0x000000006d3dbf661c66dad0745dad2d55ac514dbb4d01f18c1cb114fe743799"); 
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nThreshold = 5; // 50% of 10
