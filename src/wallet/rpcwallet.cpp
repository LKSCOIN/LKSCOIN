...
UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    SendMoney(pwallet, address.Get(), nAmount, fSubtractFeeFromAmount, wtx, coin_control, returnfounds); 
...
UniValue sendfrom(const JSONRPCRequest& request)
{
    ...
    SendMoney(pwallet, address.Get(), nAmount, false, wtx, no_coin_control, returnfounds); 
